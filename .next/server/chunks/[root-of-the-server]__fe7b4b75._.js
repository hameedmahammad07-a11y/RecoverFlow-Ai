...
async function GET() {
    try {
        ...
        const merchant = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].merchant.findUnique({
            where: {
                id: merchantId
            }
        });
        ...
        const eligibleWorkflows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].recoveryWorkflow.findMany({
            where: {
                merchantId,
                status: {
                    in: [
        ...
        const activeIncidents = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].incident.findMany({
            where: {
                merchantId,
                status: 'ACTIVE'
            }
        ...
        const timeSeries24H = [
            ...
            {
                time: 'NOW',
                revenue: liveEarnings,
                successCount: totalTransactions,
                failCount: totalFailedCount
            }
        ];
        ...
        const aiPulse = {
            now: {
                ...
                summary: activeIncidents.length > 0 ? `UPI failure rate elevated to 13.2% (baseline 4.0%). 23 failed transactions eligible for recovery.` : `Payment health is stable. 23 uncompleted purchase opportunities currently eligible for recovery.`,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            paymentHealth: {
                upi: {
                    successRate: `${upiSuccessRate}%`,
                    status: Number(upiSuccessRate) < 94 ? 'WARNING' : 'HEALTHY',
                    failRate: `${upiFailRate.toFixed(1)}%`
                },
                cards: {
                    successRate: `${cardSuccessRate}%`,
                    status: 'HEALTHY',
                    failRate: `${cardFailRate.toFixed(1)}%`
                },
                netBanking: {
                    successRate: `${netbankingSuccessRate}%`,
                    status: 'HEALTHY',
                    failRate: `${netbankingFailRate.toFixed(1)}%`
                }
            },
