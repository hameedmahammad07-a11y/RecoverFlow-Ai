...
"[project]/src/app/webhooks/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WebhookPlaygroundPage() {
    _s();
    const [provider, setProvider] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('RAZORPAY');
    const [payloadText, setPayloadText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(JSON.stringify(razorpayTemplate, null, 2));
    const [secretKey, setSecretKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('whsec_029481928401928401294801');
    const [signatureStatus, setSignatureStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('VALID');
    const [logs, setLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [dispatching, setDispatching] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleDispatchWebhook = async ()=>{
        setDispatching(true);
        try {
            var _parsed_payload_payment_entity, _parsed_payload_payment, _parsed_payload, _data_payment;
            let parsed;
            try {
            ...
            const amount = parsed.amount || (((_parsed_payload = parsed.payload) === null || _parsed_payload === void 0 ? void 0 : (_parsed_payload_payment = _parsed_payload.payment) === null || _parsed_payload_payment === void 0 ? void 0 : (_parsed_payload_payment_entity = _parsed_payload_payment.entity) === null || _parsed_payload_payment_entity === void 0 ? void 0 : _parsed_payload_payment_entity.amount) ? parsed.payload.payment.entity.amount / 100 : 2500);
            ...
            const newLog = {
                id: "wh_log_".concat(Date.now()),
                time: new Date().toLocaleTimeString(),
                provider,
                event: parsed.event || 'PAYMENT_FAILED',
                signature: 'HMAC_SHA256_VERIFIED',
                status: '200 OK',
                paymentId: ((_data_payment = data.payment) === null || _data_payment === void 0 ? void 0 : _data_payment.id) || 'pay_test'
            };
            setLogs((prev)=>[
                    newLog,
                    ...prev
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            'STRIPE'
                                                ...
                                                className: "px-2.5 py-1 rounded-lg text-xs font-bold transition-all ".concat(provider === p ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-dark-surface text-slate-400 hover:text-white'),
                                                children: p
                                            }, p, false, {
                                                fileName: "[project]/src/app/webhooks/page.tsx",
                                                lineNumber: 131,
...
_s(WebhookPlaygroundPage, "3dcAGvb1Cuz61uZLsJQ/RfPIhIQ=");
_c = WebhookPlaygroundPage;
var _c;
__turbopack_context__.k.register(_c, "WebhookPlaygroundPage");
...
//# sourceMappingURL=_1b876e99._.js.map